    ...
    <LegalLayout title="Terms of Service">
      <main className="mx-auto flex w-full max-w-8xl flex-col gap-8 pr-8 text-white">
        <section>
          ...
          <p>
            By accessing or using the Truth or Dare App and (or) Website, you
        ...
        <section>
          <h2 className="font-bold text-lg">2. Use of Service</h2>
          <p>
        ...
        <section>
          <h2 className="font-bold text-lg">3. User Accounts</h2>
          <p>
        ...
        <section>
          <h2 className="font-bold text-lg">7. Changes to Terms</h2>
          <p>
