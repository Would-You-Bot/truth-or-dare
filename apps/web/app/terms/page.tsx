...
export default function TermsOfServicePage() {
  return (
    <LegalLayout title="Terms of Service">
      ...
      <p>
        By accessing or using the Truth or Dare App, you agree to be bound by
      ...
      <p>
        ...
        and will remain the exclusive property of Truth or Dare App and its
